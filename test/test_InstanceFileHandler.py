...
import unittest
import os
from nasa_val_config_utilities.InstanceFileHandler import InstanceFileHandler
...
class instanceFileHandlerTests(unittest.TestCase):
	...
	def testGetChannels(self):
		...
		channelsToCheck = ['/right_arm','/left_arm','/right_leg','/left_leg','/neck','/trunk']
	...
	def testGetDevices(self):
		...
		devicesToCheck = ['pelvis_imu1', 'pelvis_imu2', 'torso_imu1', 'torso_imu2', 'left_foot_force_torque', 'right_foot_force_torque']
	...
	def testLoadXMLCoeffs(self):
		...
		assert cmp(instanceFileHandler.loadXMLCoeffs('v_a_001.xml'),expectedCoeffs) == 0
